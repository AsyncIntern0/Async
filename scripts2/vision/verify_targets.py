...
from vision.detect_targets import TargetMarker
...
# DEBUG DRAWING
# ==========================================================
def draw_verified_targets(frame, verified_targets):

    output = frame.copy()

    for index, target in enumerate(verified_targets):

        marker = target.marker

        cx = int(marker.center_x)
        cy = int(marker.center_y)
